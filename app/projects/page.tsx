              ...
              <div className="p-6">
                ...
                <div className="text-center">
                  <a
                    ...
                    target={selectedProject.title === "Ray Traced Audio Engine" ? "_self" : "_blank"}
                    rel={selectedProject.title === "Ray Traced Audio Engine" ? undefined : "noopener noreferrer"}
                    className="inline-block px-6 py-2 hover:bg-opacity-90 text-white rounded transition-colors font-mono"
                    style={{ backgroundColor: '#0F0909' }}
                  >
                    {selectedProject.title === "Ray Traced Audio Engine" ? "View Project" : "View on GitHub"}
                  </a>
                </div>
              </div>
            </motion.div>
